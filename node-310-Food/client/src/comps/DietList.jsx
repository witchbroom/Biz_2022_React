...
props에서 직접 분해하여(비구조화, spread) 직접
foods 변수에 담기
*/
const DietList = ({ foods, removeFoodItem }) => {
  const removeEvent = (e, d_id) => {
    // 표준 JS 함수중에 react 에서 사용할 수 없는 함수들이 일부 있다
    // 그중 confirm 함수도 자체지원이 되지 않아 browse의 함수를
